...
class ALBEF(nn.Module):
    def __init__(self,                 
        ...
        self.visual_encoder = resnet101(pretrained=True)  
        self.vision_width = self.visual_encoder.width
        ...
        bert_config.encoder_width = self.vision_width
        ...
        self.visual_encoder_m = resnet101(pretrained=True)    
        self.visual_encoder_m.fc = nn.Sequential(
                                  nn.Linear(self.vision_width,self.vision_width),
                                  nn.ReLU(),
                                  nn.Linear(self.vision_width,embed_dim),
                                ) 
    ...
    def forward(self, image, text, alpha=0):
        ...
        image_feat, image_embeds = self.visual_encoder(image) 
        ...
        with torch.no_grad():
            ...
            image_feat_m, image_embeds_m = self.visual_encoder_m(image) 
