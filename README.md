...
## Announcement: Code and models for ALBEF has been migrated to [LAVIS](https://github.com/salesforce/LAVIS) - a one-stop library for language-and-vision research and applications!
